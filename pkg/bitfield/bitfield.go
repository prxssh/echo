...
// HasBit returns true if the bit at the give index is set
...
// ClearBit clears the bit at the give index to 0
...
// String returns a human-readable representation of the bitfield
